...
<body>
    <form method="post" action="${ctx }/PlantOper/Fruit/PlantFruitBaggingEdit.ajax" id="form1">
       <div class="edit_panel">
            ...
            <tr>
                <td><div class="th_text">果树:</div></td>
                <td>
...
<%--                     <input name="operators" type="text" value="${plantLot.operators }" id="txt_Operators" class="inw" /> --%>
                ...
                <td><div class="th_text">果袋来源:</div></td>
                <td>
                    <input name="boxsource" type="text" value="" id="txt_BoxSource" class="inw" />
<%--                     <input name="boxsource" type="text" value="${plantLot.boxsource }" id="txt_BoxSource" class="inw" /> --%>
                </td>
                
            </tr>
                <tr>
                <td><div class="th_text">果袋类型:</div></td>
                <td>
                    <input name="boxtype" type="text" value="" id="txt_BoxType" class="inw" />
<%--                     <input name="boxtype" type="text" value="${plantLot.boxtype }" id="txt_BoxType" class="inw" /> --%>
                </td>
                <td><div class="th_text">果袋合格证号:</div></td>
                <td>
                    <input name="boxno" type="text" value="" id="txt_BoxNo" class="inw" />
<%--                     <input name="boxno" type="text" value="${plantLot.boxno }" id="txt_BoxNo" class="inw" /> --%>
                </td>
            ...
            <tr>
                ...
                <td colspan="3">
                    <input name="notes" type="text" value="" id="txt_Notes" class="inw" />
<%--                     <input name="notes" type="text" value="${plantLot.notes }" id="txt_Notes" class="inw" /> --%>
                </td>
