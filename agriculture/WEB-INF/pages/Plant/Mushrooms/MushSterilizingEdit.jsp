...
<body>
    <form method="post" action="${ctx }/PlantOper/Mushrooms/MushSterilizingEdit.ajax" id="form1">
		...
		<table class="edit_table" width="99%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td>
                    <div class="th_text">灭菌时间:</div>
                </td>
                <td>
                    <input name="sterilizingTime" value="" type="text" id="txt_Sterilizing_Time" class="inw" />
<%--                     <input name="sterilizingTime" value="${plantLot.sterilizingTime }" type="text" id="txt_Sterilizing_Time" class="inw" /> --%>
                </td>
                <td>
                    <div class="th_text">压力（KPa）:</div>
                </td>
                <td>
                    <input name="pressure" value="" type="text" id="txt_Pressure" class="inw" />
<%--                     <input name="pressure" value="${plantLot.pressure }" type="text" id="txt_Pressure" class="inw" /> --%>
                </td>
                
            </tr>
            <tr>
                <td>
                    <div class="th_text">温度:</div>
                </td>
                <td>
                    <input name="temperature" value="" type="text" id="txt_Temperature" class="inw" />
<%--                     <input name="temperature" value="${plantLot.temperature }" type="text" id="txt_Temperature" class="inw" /> --%>
                </td>
                <td>
