...
<body>
    <form method="post" action="${ctx }/PlantOper/Mushrooms/MushVaccEdit.ajax" id="form1">
		...
		<table class="edit_table" width="99%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td>
                    <div class="th_text">接种时间:</div>
                </td>
                <td>
                    <input name="vaccinateTime" value="" type="text" id="txt_Vaccinate_Time" class="inw" />
<%--                     <input name="vaccinateTime" value="${plantLot.vaccinateTime }" type="text" id="txt_Vaccinate_Time" class="inw" /> --%>
                </td>
                <td>
