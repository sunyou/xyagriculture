...
<body>
    <form method="post" action="${ctx }/PlantOper/Mushrooms/MushFosterEdit.ajax" id="form1">
       <div class="edit_panel">
		<table class="edit_table" width="99%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td>
                    <input name="txt_CoFarmerName" type="text" value="${plantLot.cofarmerName }" id="txt_CoFarmerName" disabled="disabled" class="aspNetDisabled inw" />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input name="txt_Goods" type="text" value="${plantLot.goodsName }" id="txt_Goods" disabled="disabled" class="aspNetDisabled inw" />
                </td>
                <td>
                    <div class="th_text">种植批次:</div>
                </td>
                <td>
                    <input name="txt_PlantLot" type="text" value="${plantLot.plotNo }" id="txt_PlantLot" disabled="disabled" class="aspNetDisabled inw" />
                </td>
            </tr>
            <tr>
                <td>
                    <div class="th_text">培养温度:</div>
                </td>
                <td>
                    <input name="fosterTem" value="" type="text" id="txt_Foster_Tem" class="inw" />
<%--                     <input name="fosterTem" value="${plantLot.fosterTem }" type="text" id="txt_Foster_Tem" class="inw" /> --%>
                </td>
                <td>
                    <div class="th_text">培养湿度:</div>
                </td>
                <td>
                    <input name="fosterHum" value="" type="text" id="txt_Foster_Hum" class="inw" />
<%--                     <input name="fosterHum" value="${plantLot.fosterHum }" type="text" id="txt_Foster_Hum" class="inw" /> --%>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="th_text">CO2含量:</div>
                </td>
                <td>
                    <input name="fosterCo2" value="" type="text" id="txt_Foster_CO2" class="inw" />
<%--                     <input name="fosterCo2" value="${plantLot.fosterCo2 }" type="text" id="txt_Foster_CO2" class="inw" /> --%>
                </td>
                <td>
                    <div class="th_text">培养期限:</div>
                </td>
                <td>
                    <input name="fosterTime" value="" type="text" id="txt_Foster_Time" class="inw" />
<%--                     <input name="fosterTime" value="${plantLot.fosterTime }" type="text" id="txt_Foster_Time" class="inw" /> --%>
                </td>
            </tr>
            <tr>
                <td>
