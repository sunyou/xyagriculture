...
<body>
    <form method="post" action="${ctx }/PlantOper/Vegetables/PlantOtherEdit.ajax" id="form1">
    <div class="edit_panel">
		<table class="edit_table" width="99%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td nowrap>
                    <div class="th_text">操作类型:</div>
                </td>
                <td>
                    <input name="operatetypename" type="text" id="txt_OperateTypeName" class="inw" value="" />
<%--                     <input name="operatetypename" type="text" id="txt_OperateTypeName" class="inw" value="${plantLot.operatetypename }" /> --%>
                </td>
