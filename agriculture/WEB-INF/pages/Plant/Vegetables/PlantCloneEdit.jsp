...
<body style="overflow: hidden;">
    <form method="post" action="${ctx }/PlantOper/Vegetables/PlantCloneEdit.ajax" id="form1">
		...
		<table class="edit_table" width="99%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td>
                    <input name="txt_CoFarmerName" type="text" disabled="disabled" value="${plantLot.cofarmerName }" id="txt_CoFarmerName" class="inw" />
                </td>
                
            </tr>
            <tr>
                <td><div class="th_text">作物:</div></td>
                <td>
