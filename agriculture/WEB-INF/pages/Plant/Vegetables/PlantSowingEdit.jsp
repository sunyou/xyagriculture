...
<body>
    <form method="post" action="${ctx }/PlantOper/Vegetables/PlantSowingEdit.ajax" id="form1">
		...
		<table class="edit_table" width="99%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td>
                    <input name="txt_CoFarmerName" type="text" disabled="disabled" id="txt_CoFarmerName" value="${plantLot.cofarmerName }" class="inw" />
                </td>
