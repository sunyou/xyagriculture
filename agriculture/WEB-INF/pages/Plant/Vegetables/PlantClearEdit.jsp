...
<body>
    <form method="post" action="${ctx }/PlantOper/Vegetables/PlantClearEdit.ajax" id="form1">
		...
		<table class="edit_table" width="99%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td>
                	...
                	<input name="operateDate" type="text" id="txt_Operate_Date" value="<fmt:formatDate value="<%=new java.util.Date() %>" pattern="yyyy-MM-dd"/>" class="Wdate inw" onclick="WdatePicker({ dateFmt: 'yyyy-MM-dd' })" readonly="readonly" />
                </td>
