...
<body>
    <form method="post" action="${ctx }/PlantOper/Vegetables/PlantWaterEdit.ajax" id="form1">
		...
		<table class="edit_table" width="99%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td nowrap>
                        <div class="th_text">灌溉方式:</div>
                    </td>
                    <td>
                        <select name="watermode" id="Drop_WaterMode" class="inw">
                    ...
                    <td nowrap>
                        <div class="th_text">浇水量:</div>
                    </td>
                    <td>
                        <input name="dosage" type="text" value="" id="txt_Dosage" class="inw" /></td>
<%--                         <input name="dosage" type="text" value="${plantLot.dosage }" id="txt_Dosage" class="inw" /></td>--%>                    
                </tr>
                <tr>
                    <td nowrap>
                    ...
                    <td>
                        <input name="operators" type="text" value="" id="txt_Operators" class="inw" /></td>
<%--                         <input name="operators" type="text" value="${plantLot.operators }" id="txt_Operators" class="inw" /></td> --%>
                    ...
                    <td>
                        <input name="notes" type="text" id="txt_Notes" value="" class="inw" /></td>
<%--                         <input name="notes" type="text" id="txt_Notes" value="${plantLot.notes }" class="inw" /></td> --%>
    ...
    if('${plantLot.watermode}' != ''){
		$("#Drop_WaterMode").val('${plantLot.watermode}');
	}
    </script>
</body>
</html>
