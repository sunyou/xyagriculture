        ...
        $(document).ready(function () {
            ...
            grid = $("#grid").createLigerGrid({
                header: [                    
                    ...
                    { display: '进货商', name: 'Supplier_Name', width: '200' },
                    { display: '进货编号', name: 'Bill_No', width: '200' },
                    { display: '合计金额', name: 'Amount', type: 'double', format: '0.00' },
                    { display: '采购点', name: 'Seller' },
                    ...
                    if (grid2 == null) {
                        grid2 = $("#grid2").createLigerGrid({
                            ...
                            editor: {
                                width: 450,
                                height: 350,
                                url: "/Pages/JinHuo/JinHuoDetailEdit.aspx",
                                para: ["Bill_ID"],
                            },
                            height: '',
                            leftBtns: {
                            ...
                            delayLoad: false,
                            keyID: "Detail_ID",
                            ajaxURL: "/JinHuoDetail/getJinHuoDetail"
                        });
                    } else {
            ...
            $("#btn_Add").click(function () {
                ligerWin(860, 400, 'AddJinHuo.aspx?Type=1', '新增');
            });
        });
    </script>
</head>
