...
<head>
    ...
    <script type="text/javascript">
        ...
        function OpenOne(id,type)
        {
            if (type == 'Harvest') {
                url = '/Pages/Plant/Vegetables/PlantHarvestDet.aspx?ID=' + id
                ligerWin(500, 400, url, '采收信息');
            } else if (type == 'CoFarmerAudit') {
                url = '${ctx}/CoFarmerAudit/CoFarmerAuditDet.html?id=' + id
                ligerWin(845, 540, url, '生产者审核');
            } else if (type == 'SupplierAudit') {
                url = '/Pages/Audit/SupplierAuditDet.aspx?ID=' + id
                ligerWin(845, 540, url, '农资经销商审核');
            }
        }
            ...
            <div class="examine">
                ...
                <dl class="green-bg2">
                  ...
                  <dl class="green-bg3">
                    ...
                    <dd class="fl">质询<br />待反馈<a href="#" onclick="OpenMore('div_Apply','标签待审核','${ctx}/Base/Material/InquiryList.html')"><span id="inquryNum"></span></a>条</dd>
                    <div class="clear"></div>
                </dl>
...
<!-- 
            <div class="supervision-content">
                ...
                <div class="fl supervision-list">
                    <h5><span class="fl arrow-r">待办事宜</span> <span class="fr"><a href="#" onclick="OpenMore('div_Apply','待办事宜','${ctx}/CoFarmerAudit/CoFarmerAudit.html?type=UnAudit')">more</a></span><div class="clear"></div> </h5>
                    <div class="list">
                             <div id="div_Apply_Data" class="marquee6">
                                            <ul id="ul_Apply_Data"></ul>
                                        </div>
                ...
                <div class="fl supervision-list">
                    <h5><span class="fl arrow-r">工作动态</span> <span class="fr"><a href="#" onclick="OpenMore('div_Audit','工作动态','${ctx}/CoFarmerAudit/CoFarmerAudit.html?type=Audit')">more</a></span><div class="clear"></div> </h5>
                    <div class="list">
                         <div id="div_Audit_Data" class="marquee6">
                                            <ul id="ul_Audit_Data"></ul>
                                        </div>
  ...
  -->           
    ...
    <div class="supervision-content">
                    ...
                    <div class="list">
							...
							<c:if test="${not empty nyBeans}">
								<c:forEach items="${nyBeans}" var="nyBean">
									<li><a href="#">${nyBean.cofarmerName}对${nyBean.plotName}地块的${nyBean.goodsfullname}使用了${nyBean.materialName}农药</a><span class="time">${nyBean.operateDate}</span></li>
								</c:forEach>
							</c:if>
                ...
                <div class="fl supervision-list" style="height:200px;">
                    ...
                    <div class="list">
                          ...
                          <c:if test="${not empty flBeans}">
								<c:forEach items="${flBeans}" var="flBean">
									<li><a href="#">${flBean.cofarmerName}对${flBean.plotName}地块的${flBean.goodsfullname}使用了${flBean.materialName}肥料</a><span class="time">${flBean.operateDate}</span></li>
								</c:forEach>
							</c:if>
                 ...
                 <div class="supervision-content" >
                   <div class="fl supervision-list" style="height:200px;">
                    <h5><span class="fl arrow-r">采收记录</span> <span class="fr"><a href="#" onclick="OpenMore('div_Apply','待办事宜','${ctx}/CoFarmerAudit/CoFarmerAudit.html?type=UnAudit')">more</a></span><div class="clear"></div> </h5>
                    <div class="list">
                     <ol>
                             <c:if test="${not empty harvestList}">
								<c:forEach items="${harvestList}" var="harvestBean">
									<li><a href="#">${harvestBean.cofarmerName}采收了${harvestBean.goodsName}${harvestBean.notes}</a><span class="time">${harvestBean.operateDate}</span></li>
								</c:forEach>
							</c:if>
							<c:if test="${empty flBeans}">
							             暂无消息...
                    ...
                    <ol>
                          <c:if test="${not empty labeBeans}">
								<c:forEach items="${labeBeans}" var="labeBean">
									<li><a href="#">${labeBean.cofarmerName}打印了${labeBean.labelcount}张溯源标签</a><span class="time">${labeBean.printDate}</span></li>
								</c:forEach>
							</c:if>
							<c:if test="${empty flBeans}">
							             暂无消息...
                    ...
                    <div class="list">
                          ...
                          <c:if test="${not empty inputList}">
								<c:forEach items="${inputList}" var="inputBean">
									<li><a href="#">${inputBean.cofarmerName}打印了${labeBean.labelcount}张溯源标签</a><span class="time">${labeBean.printDate}</span></li>
								</c:forEach>
							</c:if>
							<c:if test="${empty flBeans}">
							             暂无消息...
