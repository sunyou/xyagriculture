...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            grid = $("#grid").createLigerGrid({
                header: [
                    ...
                    { display: '施肥日期', name: 'Operate_Date',width:80, type: 'date', format: 'yyyy-MM-dd' },
                     { display: '施肥的合作社名称/基地/地块/面积', name: 'CoFarmer_Name',width:'450',render:function(rowdata, index, value) {
                    ...
                    { display: '施肥的农产品名称', name: 'GoodsFullName', align: 'left' , width: '120' },
                    { display: '肥料名称', name: 'Material_Name', align: 'left',render:function(rowdata, index, value){
                    	var html = "<a href='javascript:;' class='ligerBtnDetail' onclick=\"showOperDetail('"+rowdata["PLOTOPER_ID"]+"');\">"+value+"</a>";
			             return html ;
                    } },
                    { display: '亩实际用量/标准用量(KG)',width: '180' , name: 'AmountPer' ,render: function (rowdata, index, value){return rowdata["QTY"] + "/" + rowdata["AMOUNTPER"];} }
                ...
                keyID: "PLOTOPER_ID",
                ajaxURL: "${ctx}/Base/Material/GetCoFarmerFLList.ajax"
            });
        ...
        function showMaterialInfo(materialId){
        	myopen("${ctx}/Base/Material/MaterialFLDet.html?id="+materialId,"查看基地详情",660,260);
        }
        
         function showOperDetail(operId){
        	myopen("${ctx}/Base/Material/CoFarmerFLDet.html?id="+operId,"查看肥料使用详情",660,360);
        }
    </script>
</head>
<body>
