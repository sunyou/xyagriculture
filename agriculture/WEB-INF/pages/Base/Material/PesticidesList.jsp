        ...
        $(document).ready(function () {
            ...
            grid = $("#grid").createLigerGrid({
                header: [
                    ...
                    { display: '生产厂家', name: 'Producer', width: '230'  },
                    { display: '主要成分', name: 'MainComponent', width: '180' },
                    { display: '含量', name: 'HanLiang', width: '200' },
                    { display: '毒性', name: 'ToXicity' , width: '70'}
                ],
            ...
            //    ligerWin(470, 470, '${ctx}/Base/Material/PesticidesEdit.html?type=1', '新增农药');
            //});
