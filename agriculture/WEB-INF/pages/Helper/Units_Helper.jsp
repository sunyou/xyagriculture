...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            UnitType = GetQueryString('UnitType');
            if (!UnitType) {
                UnitType = 0;
            }
            grid = $("#grid").createLigerGrid({
                header: [
                    ...
                    { display: '单位名称', width: 100, align: 'center', name: 'UnitName' },
                    { display: '字母单位', align: 'left', name: 'Code', width: 100 },
                    { display: '拼音缩写', align: 'left', name: 'PYShort' }
                ],
                leftBtns: { show: false },
                ...
                param: { 'flag': 1 ,'UnitType':UnitType},
                keyID: "UNITSID",
                ajaxURL: "${ctx}/Package/GetUnitsList.ajax",
                width: 650
            });

            $("#btn_Search").click(function () {
                grid.setParm("unitName", $("#UnitName").val());
                grid.reload();
            })
    ...
    <form method="post" action="" id="form1">
        <table>
            <tr>
                ...
                <td>
                    <input type="text" name="UnitName" id="UnitName" value="" class="inw" />
                </td>
                <td>
