        ...
        $(document).ready(function () {
            grid = $("#grid").createLigerGrid({
                header: [
                    ...
                    { display: '农户', width: 50,align:'left', name: 'Farmer_Name' , width: 100 },
                    { display: '联系方式', align: 'left', name: 'Tel', width: 100 },
                { display: '生产者',align:'left', name: 'CoFarmer_Name', width:'200' }
        ],
                leftBtns: { show: false },
                ...
                param: { 'flag': 1 },
                keyID: "FARMER_ID",
                ajaxURL: "${ctx}/Farmer/GetFarmers.ajax",
                width:650
            });

            $("#btn_Search").click(function () {
                grid.setParm("farmerName", $("#Farmer_Name").val());
                grid.reload();
            });
    ...
    <form method="post" action="" id="form1">
        <table>
            <tr>
                ...
                <td>
                    <input type="text" name="Farmer_Name" id="Farmer_Name" value="" class="inw" />
                </td>
                <td>
