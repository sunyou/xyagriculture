...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><title>
    ...
    <link rel="stylesheet" type="text/css" href="${ctx}/content/js/LigerUI/css.css?v=&lt;%=LastVersion%>" />
    ...
    <script type="text/javascript" src="${ctx}/content/js/Pages/LabelByDateChart.js"></script>
    <style type="text/css">
    ...
    <div id="div_Param">
        <table style="width: 100%;">
            <tr>
                ...
                <td>
                    <label for="rdo_Year"><input type="radio" id="rdo_Year" value="month" name="rdo_Date"  />按月统计</label>
                    <label for="rdo_Month"><input type="radio" id="rdo_Month" value="day" name="rdo_Date" checked="checked" />按天统计</label>
                    <input type="number" class='liger-text l-text' id="txt_Year" min="2010" max="2100" value="2014" style="width:50px;" />年<label for="txt_Month" id="lbl_Month"><input type="number" class='liger-text l-text' id="txt_Month" style="width:30px;" value="12" min="0" max="12" />月</label></td>
            </tr>
            <tr>
                <td >生产者：</td>
                <td >
