        ...
        $(document).ready(function () {
            ...
            grid = $("#gv_SupplierGoodsVarietyApply").createLigerGrid({
                header: [
                    ...
                    { display: '农资经销商', name: 'Supplier_Name' ,width:'150',render:function(rowdata, index, value) {
                    ...
                    { display: '产地', name: 'Origin' ,width:'150'}
                ],
                 addTools: function (record, rowindex, value, column) {
                    if (record["AUDIT_RESULT"]=="0") {
                    	var html="";
                        	return "<input type='button' class='rowSelectButton' value='批准' onclick=\"Audit('" + record["APPLYGOODSVARIETY_ID"] + "')\">&nbsp&nbsp"+"<input type='button' class='rowSelectButton' value='驳回'  onclick=\"ligerWin(660,360, '${ctx}/GoodVariety/ApplyGoodsVarietyReason.html?type=2&id=" + record["APPLYGOODSVARIETY_ID"] + "', '填写驳回原因');\">";
                       // html= " <input type='button' class='rowSelectButton' value='批准' onclick=\"Audit('" + record["APPLYGOODSVARIETY_ID"] + "')\"/>&nbsp&nbsp"+"<input type='button' class='rowSelectButton' value='驳回' onclick=\"ligerWin(660,360, '{ctx}/GoodVariety/ApplyGoodsVarietyReason.html?type=2&id=" + record["APPLYGOODSVARIETY_ID"] + "', '填写驳回原因');\"/>";
                   		//return html;
                    }else{
                        return "已审核";
