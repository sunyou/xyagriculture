...
<body>
    ...
    <table align="center" style="width: 589px">
        ...
        <tr>
            <td class="style6">
                <span id="Label3" runat="server">PackPath:</span>
            </td>
            <td class="style3" colspan="3">
        ...
        <tr>
            ...
            <td class="style11">
                <input name="txtOutPath" runat="server" type="text" 
        ...
        <td class="style6">
            ...
            <td class="style10" colspan="3">
                <asp:FileUpload ID="k8upload" runat="server" ToolTip="上传" Width="212px" 
...
<script runat="server">
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        txtOutPath.Value = Server.MapPath(".") + "\\web_" + k8time;
    }
