...
var t=$(_32e);
return {requiredted:(t.attr("requiredted")?(t.attr("requiredted")=="requiredted"||t.attr("requiredted")=="true"||t.attr("requiredted")==true):undefined),validType:(t.attr("validType")||undefined),missingMessage:(t.attr("missingMessage")||undefined),invalidMessage:(t.attr("invalidMessage")||undefined)};
};
$.fn.validatebox.defaults={requiredted:false,validType:null,missingMessage:"当前值不能为空.",invalidMessage:null,rules:{email:{validator:function(_32f){
...
},message:"请输入一个正确的邮箱地址."},url:{validator:function(_330){
