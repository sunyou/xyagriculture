...
(function (e, t) {
	function h(e, t, n) {
		...
		for (; r < u; r++) {
			a.test(o[r].className) && (s[i] = o[r], i++);
		}
		return s;
	}
	function p(r) {
	...
	return e.$ === t && (e.$ = n), n.fn = n.prototype = {constructor:n, ready:function (e) {
		...
		if (typeof e == "string") {
			r = u.exec(e);
			if (r && r[2]) {
				return i = t.getElementById(r[2]), i && i.parentNode && (this[0] = i), this;
			}
		}
		...
		return function (r) {
			...
			for (var i = 0, s = t.listeners, o; o = s[i++]; ) {
				o.call(t.elem, r) === !1 && (r.preventDefault(), r.stopPropagation());
			}
		};
	}, fix:function (e) {
		if (e.target) {
		...
		if (document.addEventListener) {
			document.addEventListener("DOMContentLoaded", s, !1), e.addEventListener("load", n.ready, !1);
		} else {
		...
		return p.curAnim = {}, n.each(e, function (e, t) {
			...
			if (e === "height" || e === "width") {
				l = Math.max(0, l), o = [s.style.overflow, s.style.overflowX, s.style.overflowY];
			}
			u.custom(f, l, h);
	...
	v.fn = v.prototype = {version:"4.1.7", closed:!0, _init:function (e) {
		...
		if (e || e === 0) {
			r._left = e.toString().indexOf("%") !== -1 ? e : null, e = r._toNumber(e, v - g), typeof e == "number" ? (e = u ? e += l : e + p, b.left = Math.max(e, p) + "px") : typeof e == "string" && (b.left = e);
		}
		if (t || t === 0) {
			r._top = t.toString().indexOf("%") !== -1 ? t : null, t = r._toNumber(t, m - y), typeof t == "number" ? (t = u ? t += c : t + d, b.top = Math.max(t, d) + "px") : typeof t == "string" && (b.top = t);
		}
		...
		for (; e < o.length; e++) {
			t = o[e], n = t.currentStyle.png, n && (r = s + n, i = t.runtimeStyle, i.backgroundImage = "none", i.filter = "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + r + "',sizingMethod='crop')");
		}
	...
	v._templates = "<div class=\"aui_outer\"><table class=\"aui_border\"><tbody><tr><td class=\"aui_nw\"></td><td class=\"aui_n\"></td><td class=\"aui_ne\"></td></tr><tr><td class=\"aui_w\"></td><td class=\"aui_c\"><div class=\"aui_inner\"><table class=\"aui_dialog\"><tbody><tr><td colspan=\"2\" class=\"aui_header\"><div class=\"aui_titleBar\"><div class=\"aui_title\"></div><a class=\"aui_close\" href=\"javascript:;\">\xd7</a></div></td></tr><tr><td class=\"aui_icon\"><div class=\"aui_iconBg\"></div></td><td class=\"aui_main\"><div class=\"aui_content\"></div></td></tr><tr><td colspan=\"2\" class=\"aui_footer\"><div class=\"aui_buttons\"></div></td></tr></tbody></table></div></td><td class=\"aui_e\"></td></tr><tr><td class=\"aui_sw\"></td><td class=\"aui_s\"></td><td class=\"aui_se\"></td></tr></tbody></table></div>", v.defaults = {content:"<div class=\"aui_loading\"><span>loading..</span></div>", title:"\u6d88\u606f", button:null, ok:null, cancel:null, init:null, close:null, okVal:"\u786e\u5b9a", cancelVal:"\u53d6\u6d88", width:"auto", height:"auto", minWidth:96, minHeight:32, padding:"20px 25px", skin:"", icon:null, time:null, esc:!0, focus:!0, show:!0, follow:null, path:o, lock:!1, background:"#000", opacity:0.7, duration:300, fixed:!1, left:"50%", top:"38.2%", zIndex:1987, resize:!0, drag:!0}, t.artDialog = e.dialog = e.artDialog = v;
