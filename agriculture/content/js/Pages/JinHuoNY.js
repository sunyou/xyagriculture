...
function addRows(alow) {    
    ...
    trHTML += "<td><select id=\"Type_" + id + "\" onchange=\"typeChanged('" + id + "');\"><option value='1'>肥料</option><option value='2'>农药</option></select></td>";
    trHTML += "<td><input type='text' id='txt_MaterialName_" + id + "'></td>";
    trHTML += "<td><input type='text' id='txt_Brand_" + id + "'></td>";
    trHTML += "<td id=\"td_DoseType_" + id + "\"><input type='text' id='txt_DoseType_" + id + "'></td>";
    trHTML += "<td><input type='text' id='txt_ProduceNo_" + id + "'></td>";
    trHTML += "<td><input type='text' id='txt_Specification_" + id + "'></td>";
    trHTML += "<td><input type='text' id='txt_Producer_" + id + "'></td>";
    trHTML += "<td><input type='text' id='txt_ProductionDate_" + id + "' onclick='WdatePicker({ dateFmt: 'yyyy-MM-dd' })'></td>";
...
function saveDetail() {
    ...
    $.each(trs, function (n, el) {
        ...
        var detail = {
            ...
            Produce_No: $("#txt_ProduceNo_" + id).val(),
            DoseType: $("#txt_DoseType_" + id).val(),
            Specification: $("#txt_Specification_" + id).val(),
            Producer: $("#txt_Producer_" + id).val(),
            ProductionDate: $("#txt_ProductionDate_" + id).val(),
            Brand: $("#txt_Brand_" + id).val(),
            Qty: $("#txt_Qty_" + id).val(),
